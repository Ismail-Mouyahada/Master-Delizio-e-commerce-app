...
abstract class DelizioTheme {
  ...
  static DelizioTheme of(BuildContext context) =>
...
class LightModeTheme extends DelizioTheme {
  late Color primaryColor = const Color(0xFFEEC360);
...
class DarkModeTheme extends DelizioTheme {
  late Color primaryColor = const Color(0xFFEEC360);
  late Color secondaryColor = const Color(0xFF39D2C0);
  late Color tertiaryColor = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFFF5963);
