...
class FetchCall {
  static Future<ApiCallResponse> call() {
    return ApiManager.instance.makeApiCall(
      callName: 'fetch',
      apiUrl: 'https://88f9-195-25-86-163.eu.ngrok.io/api/v1/recipes',
...
class DeleteRecipeCall {
  static Future<ApiCallResponse> call() {
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: 'https://88f9-195-25-86-163.eu.ngrok.io/api/v1/recipe/delete/1',
...
class FetchOneRecipeCall {
  static Future<ApiCallResponse> call() {
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: 'https://88f9-195-25-86-163.eu.ngrok.io/api/v1/recipe/11',
      callType: ApiCallType.GET,
      headers: {
        'Accept': 'application/json',
        'Authorization': 'Bearer 5|jwwqjl0bk3KZsks2z4AtpYJ0ZTnB43bGJHhlHL9j',
    ...
    final body = '''
{
  ...
  "ingredient_id": ${ingredientId}
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: 'https://88f9-195-25-86-163.eu.ngrok.io/api/v1/recipe/create',
    ...
    final body = '''
{
  ...
  "ingredient_id": ${ingredientId}
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: 'https://88f9-195-25-86-163.eu.ngrok.io/api/v1/recipe/update/2',
